...
export default function LiveAQICard() {
  ...
  return (
    <div className="flex justify-center"> 
      {/* ⭐ SCALE WRAPPER (fixes spacing issue) */}
      <div className="scale-[0.90] origin-top w-full max-w-md">

        <div className="w-full p-8 rounded-[30px] shadow-2xl bg-[#2A2A2A] text-white font-poppins relative">
          ...
          <div className="mt-3">
            ...
            <div className="relative w-full h-4 bg-gray-700 rounded-full overflow-visible">
              <div
                ...
                from-green-500 via-yellow-300 via-orange-400 via-red-500 to-red-800"
              ></div>

              <div
                className="absolute top-1/2 -translate-y-1/2 w-8 h-8 bg-white rounded-full
                border-[6px] border-[#E74C3C] shadow-[0_0_18px_rgba(231,76,60,0.9)] z-10"
          ...
          <div className="relative group mt-6 cursor-pointer">
            ...
            {/* TOOLTIP */}
            <div
              className="absolute left-1/2 -translate-x-1/2 bottom-[65px] w-60 
              bg-[#1F1F1F] text-white text-xs rounded-xl p-4 opacity-0 
